...
## Composition (three-way, leak-free build, 2026-09-03)

- **292 datasets**, effective N = 287 after dedup; two modalities.
- Tabular 185 (adbench+dami, OddBench, OvrBench) + time series 107 (TSB-AD-U, UCR, TSB-AD-M).
...
- Filters: Wu & Keogh one-liner triviality (time series, permutation-calibrated for
  multivariate), max|z| + LinRes double-hard triviality (tabular), base-rate cap 0.25,
  mixed-label duplicate removal, floor (best < 0.10) and low-spread (< 0.10) exclusion.
