...
CEILING = ["Annthyroid", "WDBC", "Cardiotocography", "PageBlocks"]
CONFIGS = ["kmeans", "vade_default", "vade_joint150", "vade_pre100j150",
           "vade_protectclust", "vade_boostclust", "vade_latent16"]
SEEDS = [0, 1, 2]
KS = [30, 50]
...
def main():
    ...
    df.to_csv("results/vade_tuned.csv", index=False)
